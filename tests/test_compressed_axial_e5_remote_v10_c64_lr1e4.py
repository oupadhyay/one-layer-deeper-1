...
PROVEN = ROOT / "submissions/compressed_axial_e5_remote_v9_c64/submission.py"
PATH = ROOT / "submissions/compressed_axial_e5_remote_v10_c64_lr1e4/submission.py"
...
candidate = load(PATH, "compressed_axial_e5_remote_v10_c64_lr1e4")
proven = load(PROVEN, "compressed_axial_e5_remote_v9_c64_reference")


class CompressedAxialE5RemoteV10C64Lr1e4Tests(unittest.TestCase):
    def setUp(self):
