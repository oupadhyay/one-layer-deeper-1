...
PATH = ROOT / "submissions/factorized_pair_reducer_e5_remote_v1/submission.py"
module_spec = importlib.util.spec_from_file_location("factorized_pair_reducer_e5_remote_v1", PATH)
...
class FactorizedPairReducerTests(unittest.TestCase):
    ...
    def test_parsing_context_pairs_counts_and_feedback(self):
        ...
        self.assertEqual(aux["reducer_calls"],6); self.assertEqual(aux["scratch_resets"],3)
    ...
    def test_sharing_invariance_gradients_and_limits(self):
        ...
        self.assertEqual(aux["reducer_calls"],128)
