...
PATH = ROOT / "submissions/neural_gpu_e5_remote_v1_t1/submission.py"
loader = importlib.util.spec_from_file_location("neural_gpu_e5", PATH)
...
class NeuralGpuE5Tests(unittest.TestCase):
