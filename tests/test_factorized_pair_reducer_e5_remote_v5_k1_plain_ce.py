...
PATH = ROOT / "submissions/factorized_pair_reducer_e5_remote_v5_k1_plain_ce/submission.py"
...
v2 = load("factorized_pair_reducer_e5_remote_v2_k1_parity", V2_PATH)
candidate = load("factorized_pair_reducer_e5_remote_v5_k1_plain_ce", PATH)
