...
PATH = ROOT / "submissions/biscan_e1_remote_v1_large/submission.py"
module_spec = importlib.util.spec_from_file_location("biscan_e1_remote_v1_large", PATH)
...
class BiScanE1RemoteV1LargeTests(unittest.TestCase):
