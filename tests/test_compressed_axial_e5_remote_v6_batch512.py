...
PROVEN = ROOT / "submissions/compressed_axial_e5_remote_v5/submission.py"
PATH = ROOT / "submissions/compressed_axial_e5_remote_v6_batch512/submission.py"


def load():
    spec = importlib.util.spec_from_file_location("compressed_axial_e5_remote_v6_batch512", PATH)
...
class CompressedAxialE5RemoteV6Batch512Tests(unittest.TestCase):
    def setUp(self):
    ...
    def test_exact_promotion_source_diff(self):
        ...
        expected = proven.replace(
            "batch_size=64, eval_batch_size=128, max_steps=None)",
