...
PATH = ROOT / "submissions/compressed_axial_e5_remote_v11_c64_lr15e5/submission.py"
...
candidate = load(PATH, "compressed_axial_e5_remote_v11_c64_lr15e5")
proven = load(PROVEN, "compressed_axial_e5_remote_v10_c64_lr1e4_reference")


class CompressedAxialE5RemoteV11C64Lr15e5Tests(unittest.TestCase):
    def setUp(self):
    ...
    def test_exact_promotion_source_diff(self):
        ...
        self.assertEqual(changed, [
            ("    optimizer = torch.optim.AdamW(model.parameters(), lr=1e-4, betas=(0.9, 0.95),",
             "    optimizer = torch.optim.AdamW(model.parameters(), lr=1.5e-4, betas=(0.9, 0.95),")])
