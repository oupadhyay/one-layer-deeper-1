"""Diagnostic-only, deliberately non-scoring remote smoke package; do not submit."""
...
SUBMISSION = Submission(build_model, build_optimizer, batch_size=64, eval_batch_size=128, max_steps=1)
