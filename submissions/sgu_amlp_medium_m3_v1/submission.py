"""Attention-augmented spatial-gating categorical register for Medium M3."""
...
STATE_ELEMENTS, NEG = 89_048, -10_000.0
...
class SpatialGatingBlock(nn.Module):
    """gMLP SGU with one shared learned operator over the ten token positions."""
...
class Model(nn.Module):
    ...
    def forward(self, input_ids: Tensor, attention_mask: Tensor | None = None):
        ...
        if bool(invalid.any()):
            raise ValueError("N and X widths must be between one and five")
