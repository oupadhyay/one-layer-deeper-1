"""Frozen two-sweep chunkwise DeltaNet transition for the Easy benchmark."""
...
WIDTH, D_MODEL, HEADS, HEAD_DIM, TOKENS = 4, 96, 4, 24, 12
STATE_ELEMENTS = 96_106
NEG = -10000.0
...
class DeltaBlock(nn.Module):
    def __init__(self) -> None:
        ...
        self.ffn_in = nn.Linear(D_MODEL, 384, bias=False)
        self.ffn_down = nn.Linear(192, D_MODEL, bias=False)
