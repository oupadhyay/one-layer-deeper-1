"""Conditional structured-loss phase 5: focal05_batch128."""
...
SUBMISSION=Submission(build_model,build_optimizer,batch_size=128,eval_batch_size=512,max_steps=None,token_training_loss=token_training_loss)
