"""Standalone activation-normalized calibrated C12 diagonal Easy E5."""
...
STATE_ELEMENTS, NEG = 79_685, -10_000.0
...
class SpatialGatingBlock(nn.Module):
    ...
    def __init__(self) -> None:
        ...
        self.u_norm = RMSNorm(HIDDEN, eps=1e-6)
        ...
        self.spatial_bias = nn.Parameter(torch.ones(WIDTH, 2))
