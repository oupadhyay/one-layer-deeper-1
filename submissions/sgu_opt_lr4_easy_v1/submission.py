"""Standalone sgu_opt_lr4_easy_v1 optimization of RMS/axial crossing C21 for the Easy E5 tier."""
...
def build_optimizer(model: nn.Module, spec: OptimizerSpec) -> OptimizerBundle:
    ...
    optimizer = torch.optim.AdamW(
        ...
        lr=4e-4, betas=(.9, .95), eps=1e-8, capturable=spec.device_type == "cuda")
