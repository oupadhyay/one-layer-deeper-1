"""Baseline Transformer plus one diagnostic horizontal axial-cell call."""
...
class Model(nn.Module):
    ...
    def forward(
        ...
        horizontal = self.cell(workspace, "H") * valid[..., None]
        ...
        workspace_zero = horizontal.sum().to(logits.dtype) * 0.0
