...
MAX_STEPS, CHANNELS, STATE_ELEMENTS = 64, 64, 49018
...
class Model(nn.Module):
    def __init__(self, spec):
        ...
        self.place_embedding = nn.Embedding(spec.max_seq_len + 1, 16)
    ...
    def _workspace(self, probabilities, n_digits, widths):
        ...
        col_index = torch.where(boundary.expand(-1, width, -1), self.max_seq_len, col_index)
