"""Standalone RMS/axial gate-calibrated C44 for the Easy E5 tier."""
...
STATE_ELEMENTS, NEG = 79_468, -10_000.0
...
class SpatialGatingBlock(nn.Module):
    ...
    def __init__(self) -> None:
        ...
        self.place_operator = nn.Parameter(torch.empty(2, WIDTH, WIDTH))
    ...
    def forward(self, register: Tensor) -> Tensor:
        ...
        place_gate = torch.einsum("rop,bprh->borh", self.place_operator, v)
