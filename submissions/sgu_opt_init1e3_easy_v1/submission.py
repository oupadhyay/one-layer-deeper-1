"""Standalone sgu_opt_init1e3_easy_v1 optimization of RMS/axial crossing C21 for the Easy E5 tier."""
...
class SpatialGatingBlock(nn.Module):
    ...
    def __init__(self) -> None:
        ...
        nn.init.uniform_(self.place_operator, -1e-3, 1e-3)
        nn.init.uniform_(self.role_operator, -1e-3, 1e-3)
