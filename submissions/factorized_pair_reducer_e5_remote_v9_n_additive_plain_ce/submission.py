"""Factorized pair reducer with compute-efficient additive N conditioning."""
...
class Model(nn.Module):
    def __init__(self, spec):
        ...
        self.n_projection = nn.Linear(D, D)
    ...
    def _contexts(self, probabilities, nd, place_mask):
        ...
        pairs = pairs + self.n_projection(n_summary)[:, None]
