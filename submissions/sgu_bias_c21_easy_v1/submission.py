"""Standalone RMS/axial crossing C21 for the Easy E5 tier."""
...
STATE_ELEMENTS, NEG = 79_680, -10_000.0
...
class SpatialGatingBlock(nn.Module):
    ...
    def forward(self, register: Tensor) -> Tensor:
        ...
        bias = self.place_bias[:, None] + self.role_bias[None, :]
        gate = (place_gate + role_gate + bias[None, :, :, None]).reshape_as(u)
