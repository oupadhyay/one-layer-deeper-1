"""Frozen E1 bidirectional decimal scan, packaged for the full remote budget."""
...
SUBMISSION = Submission(build_model, build_optimizer, batch_size=512, eval_batch_size=512,
                        max_steps=None)
