"""Official Easy-tier package of loop13; includes a CUDA parser compatibility fix."""
...
SUBMISSION = Submission(build_model, build_optimizer, batch_size=64, eval_batch_size=128, max_steps=None)
