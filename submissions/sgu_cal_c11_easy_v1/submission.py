"""Standalone RMS/axial gate-calibrated C11 for the Easy E5 tier."""
...
STATE_ELEMENTS, NEG = 79_464, -10_000.0
...
class SpatialGatingBlock(nn.Module):
    ...
    def __init__(self) -> None:
        ...
        self.role_operator = nn.Parameter(torch.empty(WIDTH, 2, 2))
    ...
    def forward(self, register: Tensor) -> Tensor:
        ...
        role_gate = torch.einsum("por,bprh->bpoh", self.role_operator, v)
        gate = place_gate + role_gate + self.spatial_bias[None, :, :, None]
